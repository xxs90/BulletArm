...
class CloseLoopFixedShoePackingPlanner(CloseLoopPlanner):
  ...
  def setWaypoints(self):
    ...
    self.pre_grasp_pos_left = [shoe_left_pos[0], shoe_left_pos[1], shoe_rack_pos_left[2] + 0.1]
    self.grasp_pos_left = [shoe_left_pos[0], shoe_left_pos[1], shoe_left_pos[2] + 0.005]
    self.post_grasp_pos_left = [shoe_left_pos[0], shoe_left_pos[1], shoe_rack_pos_left[2] + 0.05]
    self.release_pos_left = [shoe_rack_pos_left[0], shoe_rack_pos_left[1], shoe_rack_pos_left[2] + 0.05]

    self.pre_grasp_pos_right = [shoe_right_pos[0], shoe_right_pos[1], shoe_rack_pos_right[2] + 0.1]
    self.grasp_pos_right = [shoe_right_pos[0], shoe_right_pos[1], shoe_right_pos[2] + 0.005]
    self.post_grasp_pos_right = [shoe_right_pos[0], shoe_right_pos[1], shoe_rack_pos_right[2] + 0.05]
