...
class CloseLoopKitchenSettingPlanner(CloseLoopPlanner):
  ...
  def setWaypoints(self):
    ...
    self.pre_grasp_pos_fork = [fork_pos[0], fork_pos[1], fork_pos[2] + 0.15]
    self.grasp_pos_fork = [fork_pos[0], fork_pos[1], fork_pos[2] + 0.005]
    self.post_grasp_pos_fork = [fork_pos[0], fork_pos[1], fork_pos[2] + 0.15]
